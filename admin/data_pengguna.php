...
<body>
  ...
  <header>
    ...
    <nav>
      ...
      <a href="data_pengguna.php" class="active">Data Petugas</a>
  ...
  <div class="filter-container">
    ...
    <button onclick="window.location.href='tambah_pengguna.php'">+ Tambah Petugas</button>
  </div>
